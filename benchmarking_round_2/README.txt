...
Output data and plots are contained in the adjacent directory (benchmarking_round_2\output) with separate directories for each experimentthat contributed to this exercise  (dir name = COMPS experiment id).
